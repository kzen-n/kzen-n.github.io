...
assessmentButton.addEventListener(
	...
	() => {
		...
		*/
		...
		const anchor = document.createElement("a"); //a要素を作成
...
userNameInput.addEventListener(
	"keydown",
	(event) => {
		if(event.code == "Enter") assessmentButton.dispatchEvent(new Event("click"));
	}
)
...
function assessment(userName){
	...
	//文字のコード番号の合計を回答の数で割ることで、添字の数値を求める
